...
VL_ATTR_COLD void VTBdesign___024root___eval_static__TOP(VTBdesign___024root* vlSelf);
VL_ATTR_COLD void VTBdesign___024root____Vm_traceActivitySetAll(VTBdesign___024root* vlSelf);

VL_ATTR_COLD void VTBdesign___024root___eval_static(VTBdesign___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VTBdesign___024root___eval_static\n"); );
    VTBdesign__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    VTBdesign___024root___eval_static__TOP(vlSelf);
    VTBdesign___024root____Vm_traceActivitySetAll(vlSelf);
...
VL_ATTR_COLD void VTBdesign___024root___eval_static__TOP(VTBdesign___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VTBdesign___024root___eval_static__TOP\n"); );
    VTBdesign__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
    IData/*31:0*/ __Vilp1;
    ...
    vlSelfRef.tb__DOT__dut__DOT__unincr_rd__Vstatic__raddr = 0U;
    vlSelfRef.tb__DOT__dut__DOT__wrap_rd__Vstatic__addr1 = 0U;
    vlSelfRef.tb__DOT__dut__DOT__wrap_rd__Vstatic__addr2 = 0U;
    vlSelfRef.tb__DOT__dut__DOT__wrap_rd__Vstatic__addr3 = 0U;
    vlSelfRef.tb__DOT__dut__DOT__wrap_rd__Vstatic__addr4 = 0U;
...
VL_ATTR_COLD void VTBdesign___024root___eval_initial__TOP(VTBdesign___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VTBdesign___024root___eval_initial__TOP\n"); );
    VTBdesign__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void VTBdesign___024root___eval_final(VTBdesign___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VTBdesign___024root___eval_final\n"); );
    VTBdesign__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
}

#ifdef VL_DEBUG
VL_ATTR_COLD void VTBdesign___024root___dump_triggers__stl(const VlUnpacked<QData/*63:0*/, 2> &triggers, const std::string &tag);
#endif  // VL_DEBUG
VL_ATTR_COLD bool VTBdesign___024root___eval_phase__stl(VTBdesign___024root* vlSelf);

VL_ATTR_COLD void VTBdesign___024root___eval_settle(VTBdesign___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VTBdesign___024root___eval_settle\n"); );
    VTBdesign__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
...
#ifdef VL_DEBUG
            VTBdesign___024root___dump_triggers__stl(vlSelfRef.__VstlTriggered, "stl"s);
#endif
            VL_FATAL_MT("testbench.sv", 1238, "", "DIDNOTCONVERGE: Settle region did not converge after '--converge-limit' of 10000 tries");
        }
        __VstlIterCount = ((IData)(1U) + __VstlIterCount);
        vlSelfRef.__VstlPhaseResult = VTBdesign___024root___eval_phase__stl(vlSelf);
        vlSelfRef.__VstlFirstIteration = 0U;
    } while (vlSelfRef.__VstlPhaseResult);
}

VL_ATTR_COLD void VTBdesign___024root___eval_triggers_vec__stl(VTBdesign___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VTBdesign___024root___eval_triggers_vec__stl\n"); );
    VTBdesign__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD bool VTBdesign___024root___trigger_anySet__stl(const VlUnpacked<QData/*63:0*/, 2> &in);

#ifdef VL_DEBUG
VL_ATTR_COLD void VTBdesign___024root___dump_triggers__stl(const VlUnpacked<QData/*63:0*/, 2> &triggers, const std::string &tag) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VTBdesign___024root___dump_triggers__stl\n"); );
    // Body
    if ((1U & (~ (IData)(VTBdesign___024root___trigger_anySet__stl(triggers))))) {
...
VL_ATTR_COLD bool VTBdesign___024root___trigger_anySet__stl(const VlUnpacked<QData/*63:0*/, 2> &in) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VTBdesign___024root___trigger_anySet__stl\n"); );
    // Locals
    IData/*31:0*/ n;
    // Body
    n = 0U;
...
VL_ATTR_COLD void VTBdesign___024root___stl_comb__TOP__0(VTBdesign___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VTBdesign___024root___stl_comb__TOP__0\n"); );
    VTBdesign__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void VTBdesign___024root___eval_stl(VTBdesign___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VTBdesign___024root___eval_stl\n"); );
    VTBdesign__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    if ((1ULL & (vlSelfRef.__VstlTriggered[1U] | vlSelfRef.__VstlTriggered[0U]))) {
        VTBdesign___024root___stl_comb__TOP__0(vlSelf);
        VTBdesign___024root____Vm_traceActivitySetAll(vlSelf);
    }
}

VL_ATTR_COLD bool VTBdesign___024root___eval_phase__stl(VTBdesign___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VTBdesign___024root___eval_phase__stl\n"); );
    VTBdesign__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
    CData/*0:0*/ __VstlExecute;
    // Body
    VTBdesign___024root___eval_triggers_vec__stl(vlSelf);
#ifdef VL_DEBUG
    if (VL_UNLIKELY(vlSymsp->_vm_contextp__->debug())) {
        VTBdesign___024root___dump_triggers__stl(vlSelfRef.__VstlTriggered, "stl"s);
    }
#endif
    __VstlExecute = VTBdesign___024root___trigger_anySet__stl(vlSelfRef.__VstlTriggered);
    if (__VstlExecute) {
        VTBdesign___024root___eval_stl(vlSelf);
    }
...
VL_ATTR_COLD void VTBdesign___024root___dump_triggers__ico(const VlUnpacked<QData/*63:0*/, 2> &triggers, const std::string &tag) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VTBdesign___024root___dump_triggers__ico\n"); );
    // Body
    if ((1U & (~ (IData)(VTBdesign___024root___trigger_anySet__ico(triggers))))) {
        VL_DBG_MSGS("         No '" + tag + "' region triggers active\n");
    }
    if ((1U & (IData)(triggers[0U]))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 0 is active: @([hybrid] tb.dut.retaddr)\n");
...
VL_ATTR_COLD void VTBdesign___024root___dump_triggers__act(const VlUnpacked<QData/*63:0*/, 2> &triggers, const std::string &tag) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VTBdesign___024root___dump_triggers__act\n"); );
    // Body
    if ((1U & (~ (IData)(VTBdesign___024root___trigger_anySet__act(triggers))))) {
        VL_DBG_MSGS("         No '" + tag + "' region triggers active\n");
    }
    if ((1U & (IData)(triggers[0U]))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 0 is active: @([hybrid] tb.dut.retaddr)\n");
...
VL_ATTR_COLD void VTBdesign___024root____Vm_traceActivitySetAll(VTBdesign___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VTBdesign___024root____Vm_traceActivitySetAll\n"); );
    VTBdesign__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void VTBdesign___024root___ctor_var_reset(VTBdesign___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VTBdesign___024root___ctor_var_reset\n"); );
    VTBdesign__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelf->tb__DOT____Vcellout__dut__hrdata = 0;
    vlSelf->tb__DOT____Vcellout__dut__hresp = 0;
    ...
    vlSelf->tb__DOT__dut__DOT__first = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 12093016999830779412ull);
