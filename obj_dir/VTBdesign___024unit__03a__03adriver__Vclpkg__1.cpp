...
VlCoroutine VTBdesign___024unit__03a__03adriver::__VnoInFunc_wrap16_rd____Vfork_158__0(VlProcessRef vlProcess, VTBdesign__Syms* __restrict vlSymsp, CData/*0:0*/ __Vintraval_hb01efe50__7) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VTBdesign___024unit__03a__03adriver::__VnoInFunc_wrap16_rd____Vfork_158__0\n"); );
    // Body
...
VlCoroutine VTBdesign___024unit__03a__03adriver::__VnoInFunc_wrap16_rd____Vfork_157__0(VlProcessRef vlProcess, VTBdesign__Syms* __restrict vlSymsp, CData/*2:0*/ __Vintraval_h10b6f6e4__1) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VTBdesign___024unit__03a__03adriver::__VnoInFunc_wrap16_rd____Vfork_157__0\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VL_KEEP_THIS;
...
VlCoroutine VTBdesign___024unit__03a__03adriver::__VnoInFunc_wrap16_rd____Vfork_156__0(VlProcessRef vlProcess, VTBdesign__Syms* __restrict vlSymsp, CData/*0:0*/ __Vintraval_h4743174c__16) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VTBdesign___024unit__03a__03adriver::__VnoInFunc_wrap16_rd____Vfork_156__0\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VL_KEEP_THIS;
...
VlCoroutine VTBdesign___024unit__03a__03adriver::__VnoInFunc_run(VlProcessRef vlProcess, VTBdesign__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VTBdesign___024unit__03a__03adriver::__VnoInFunc_run\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VL_KEEP_THIS;
    while (true) {
...
void VTBdesign___024unit__03a__03adriver::_ctor_var_reset(VTBdesign__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VTBdesign___024unit__03a__03adriver::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
    __PVT__aif = nullptr;
}

std::string VTBdesign___024unit__03a__03adriver::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VTBdesign___024unit__03a__03adriver::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string VTBdesign___024unit__03a__03adriver::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VTBdesign___024unit__03a__03adriver::to_string_middle\n"); );
    // Body
    std::string out;
