...
void Vdesign_std__03a__03amailbox__Tz2::init(Vdesign__Syms* __restrict vlSymsp, IData/*31:0*/ bound) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdesign_std__03a__03amailbox__Tz2::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
    this->__PVT__m_bound = bound;
}

void Vdesign_std__03a__03amailbox__Tz2::__VnoInFunc_num(Vdesign__Syms* __restrict vlSymsp, IData/*31:0*/ &num__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdesign_std__03a__03amailbox__Tz2::__VnoInFunc_num\n"); );
    // Body
    num__Vfuncrtn = this->__PVT__m_queue.size();
}

VlCoroutine Vdesign_std__03a__03amailbox__Tz2::__VnoInFunc_put(VlProcessRef vlProcess, Vdesign__Syms* __restrict vlSymsp, CData/*4:0*/ message) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdesign_std__03a__03amailbox__Tz2::__VnoInFunc_put\n"); );
    // Locals
...
void Vdesign_std__03a__03amailbox__Tz2::__VnoInFunc_try_put(Vdesign__Syms* __restrict vlSymsp, CData/*4:0*/ message, IData/*31:0*/ &try_put__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdesign_std__03a__03amailbox__Tz2::__VnoInFunc_try_put\n"); );
    // Body
...
VlCoroutine Vdesign_std__03a__03amailbox__Tz2::__VnoInFunc_get(VlProcessRef vlProcess, Vdesign__Syms* __restrict vlSymsp, CData/*4:0*/ &message) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdesign_std__03a__03amailbox__Tz2::__VnoInFunc_get\n"); );
    // Locals
...
void Vdesign_std__03a__03amailbox__Tz2::__VnoInFunc_try_get(Vdesign__Syms* __restrict vlSymsp, CData/*4:0*/ &message, IData/*31:0*/ &try_get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdesign_std__03a__03amailbox__Tz2::__VnoInFunc_try_get\n"); );
    // Body
    IData/*31:0*/ __VlefCall_0__num;
    {
...
VlCoroutine Vdesign_std__03a__03amailbox__Tz2::__VnoInFunc_peek(Vdesign__Syms* __restrict vlSymsp, CData/*4:0*/ &message) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdesign_std__03a__03amailbox__Tz2::__VnoInFunc_peek\n"); );
    // Locals
...
void Vdesign_std__03a__03amailbox__Tz2::__VnoInFunc_try_peek(Vdesign__Syms* __restrict vlSymsp, CData/*4:0*/ &message, IData/*31:0*/ &try_peek__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdesign_std__03a__03amailbox__Tz2::__VnoInFunc_try_peek\n"); );
    // Body
    IData/*31:0*/ __VlefCall_0__num;
    {
...
void Vdesign_std__03a__03amailbox__Tz2::_ctor_var_reset(Vdesign__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdesign_std__03a__03amailbox__Tz2::_ctor_var_reset\n"); );
    // Body
...
std::string Vdesign_std__03a__03amailbox__Tz2::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdesign_std__03a__03amailbox__Tz2::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vdesign_std__03a__03amailbox__Tz2::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vdesign_std__03a__03amailbox__Tz2::to_string_middle\n"); );
    // Body
    std::string out;
