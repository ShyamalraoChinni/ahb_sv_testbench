...
void VTBdesign___024unit__03a__03agenerator::init(VTBdesign__Syms* __restrict vlSymsp, VlClassRef<VTBdesign_std__03a__03amailbox__Tz1> mbxgd, VlClassRef<VTBdesign_std__03a__03amailbox__Tz2> mbxgm) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          VTBdesign___024unit__03a__03agenerator::new\n"); );
    // Body
...
VlCoroutine VTBdesign___024unit__03a__03agenerator::__VnoInFunc_run(VlProcessRef vlProcess, VTBdesign__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          VTBdesign___024unit__03a__03agenerator::__VnoInFunc_run\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VL_KEEP_THIS;
    VlClassRef<VTBdesign___024unit__03a__03atransaction> __VlefCall_2__copy;
...
void VTBdesign___024unit__03a__03agenerator::_ctor_var_reset(VTBdesign__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          VTBdesign___024unit__03a__03agenerator::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

std::string VTBdesign___024unit__03a__03agenerator::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+          VTBdesign___024unit__03a__03agenerator::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string VTBdesign___024unit__03a__03agenerator::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+          VTBdesign___024unit__03a__03agenerator::to_string_middle\n"); );
    // Body
    std::string out;
