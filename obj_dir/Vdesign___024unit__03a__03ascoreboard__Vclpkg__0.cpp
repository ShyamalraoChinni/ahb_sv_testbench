...
void Vdesign___024unit__03a__03ascoreboard::init(Vdesign__Syms* __restrict vlSymsp, VlClassRef<Vdesign_std__03a__03amailbox__Tz1> mbxms) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vdesign___024unit__03a__03ascoreboard::new\n"); );
    // Locals
    IData/*31:0*/ __Vilp1;
    // Body
...
VlCoroutine Vdesign___024unit__03a__03ascoreboard::__VnoInFunc_run(VlProcessRef vlProcess, Vdesign__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vdesign___024unit__03a__03ascoreboard::__VnoInFunc_run\n"); );
    // Body
...
void Vdesign___024unit__03a__03ascoreboard::_ctor_var_reset(Vdesign__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vdesign___024unit__03a__03ascoreboard::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
    __PVT__rdata = 0;
}

std::string Vdesign___024unit__03a__03ascoreboard::to_string() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vdesign___024unit__03a__03ascoreboard::to_string\n"); );
    // Body
    return ("'{"s + to_string_middle() + "}");
}

std::string Vdesign___024unit__03a__03ascoreboard::to_string_middle() const {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vdesign___024unit__03a__03ascoreboard::to_string_middle\n"); );
    // Body
    std::string out;
